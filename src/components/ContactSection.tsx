        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-secondary/50 rounded-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-foreground/80">Nom</label>
                <input
                  type="text"
                  id="name"
                  value={formData.name}
                  ...
                  required
                  className="mt-1 block w-full rounded-md bg-secondary/30 border border-primary/20 text-foreground px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
              <div>
          ...
          <div className="bg-secondary/50 rounded-lg p-8">
            <h3 className="text-xl font-bold text-foreground mb-4">Nos coordonnées</h3>
